...
<head>
  ...
  <style>
    ...
    header { background: #1d4ed8; color: white; padding: 10px 20px; font-size: 1.2rem; font-weight: bold; }
...
<body>
<header>CGS | Admin</header>
<div class="container">
  <div class="card">
    <h1>Welcome, <?= htmlspecialchars($user['name'] ?? $user['email']) ?></h1>
    <p>You are logged in as <strong>Admin</strong>.</p>
    <p>This is a placeholder dashboard. You can manage users, departments, programs, and workflows.</p>
