...
$pages = [
    'Users'       => 'users.php',
    'Departments' => '../super_admin/departments.php',
    'Categories' => '../super_admin/categories.php',
    'Programs'    => '../super_admin/programs.php',
    'Directories'    => '../super_admin/directories.php',
    'Sections'    => '../super_admin/sections.php',
    'Workflows'   => '../super_admin/workflows.php',
];
?>
<!doctype html>
<html lang="en">
...
<body>
  ...
  <div class="container">
    ...
    <p style="color:#6b7280;font-size:14px;margin-bottom:15px;">
      Manage users, departments, programs, and workflows within your organization.
    </p>
