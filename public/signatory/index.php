...
<head>
  ...
  <style>
    ...
    header { background: #047857; color: white; padding: 10px 20px; font-size: 1.2rem; font-weight: bold; }
...
<body>
<header>CGS | Staff</header>
<div class="container">
  <div class="card">
    <h1>Welcome, <?= htmlspecialchars($user['name'] ?? $user['email']) ?></h1>
    <p>You are logged in as <strong>Signatory/Staff</strong>.</p>
    <p>This is a placeholder dashboard. Here you will see clearance requests for approval.</p>
